...
/**
 * 本地模拟v4/cconf接口发送请求 Created by guoxx on 2019/3/21.
 */
public class V4Conf {
	...
	private static final Logger LOGGER = LogManager.getLogger(V4Conf.class.getName());
	// 接口参数
	private static String aseBody = "appkey=251ff008c22c1&plat=1&apppkg=com.mob.test.COMMON&appver=19.03.21&networktype=wifi&duid=132a9267ea753c8d9a4214888f27360018938377";
	// host
	// private static String host = "172.25.48.193:8085";
	private static String host = "m.data.mob.com";
	// urlAddr
	...
	public static JSON get() {
		...
		httpGet.setHeader("x-forwarded-for", "221.221.211.126");
	...
	public static void getResult(JSON backDataJSON) {
		...
		heards.put("x-forwarded-for", "221.221.211.126");
		heards.put("connection", "Keep-Alive");
		heards.put("user-identity",
				"APP/com.mob.test.COMMON;19.03.20 SYS/Android;22 SDI/5593fa0495d08e1ebb0c38efe79f9167e6011c2a FM/Meizu;m2+note NE/wifi;-1 Lang/zh_CN CLV/20190320 SDK/MOBPUSH;10701 DC/2 P/GROWSOLUTION;1001");
		...
		if (backDataJSON.getInteger("status") == 200) {
			...
			if (!(aseBackData == null) || ("".equals(aseBackData))) {
				// b.返回数据入库
				JSON outData = AllUtil2.outDecode("m.data.mob.com", "m.data.mob.com/v4/cconf", heards, aseBackData,
						forDes);
		...
		JSON pJson = JSON.fromJSONString(pbackData2Db);
		if (pJson.containsKey("resultData")) {
			System.out.println(pJson.get("resultData").toString());
		}
	}
